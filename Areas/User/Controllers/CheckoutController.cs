...
public class CheckoutController : BaseController
{
    ...
    [HttpPost]
    public async Task<IActionResult> Checkout(Guid shipingId, string discountCode)
    {
        ...
        if (!string.IsNullOrEmpty(discountCode))
        {
            ...
            if (discount != null)
            {
                ...
                {
                    discountAmount = (decimal)(discount.DiscountAmount + subtotal * (decimal?)(discount.DiscountPercent ?? 0) / 100);
                    discount.UsedCount++;
                                 ...
                                 <table align="center" width="600" cellpadding="0" cellspacing="0" 
                                     ...
                                     <tr>
                                         <td style="text-align: center; padding-top: 20px;">
                                             <a href="https://yourdomain.com/User/Order/Detail/{{{order.OrderId}}}"
